...
$^*$ Departamento de Ciências Exatas LCE ESALQ-USP / LEG-UFPR
\end{center}
\vspace{0.5cm}
...
Precessing Language (NLP)_ em que as palavras são caracterizadas pelo
...
únicos apresentados no evento, pois mais de um tópico pode ser atrubuído
ao mesmo artigo (veja a \autoref{fig:webscrap}). Observe também que há
uma moderada predominância de artigos cujo foram atrubuídos os três
...
textos em uma matrix $\mathbb{X}$, cujo linhas são os documentos,
